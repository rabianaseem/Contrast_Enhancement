...
if torch.cuda.is_available() :   
    ...
    #  device = torch.device('cuda', 1)  # Default CUDA device
...
class Generator(nn.Module):
    def __init__(self):
        ...
        # input 512x512x3  output 512x512x16    # 3 in nn.Conv2d(3, 16, 5, stride..) replaced by 1
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        #  Convolutional layers
        # input 512x512x3  output 512x512x16         #  nn.Conv2d(3, 16,kernel_size= 3, stride=1, padding=0),
        self.conv1 = nn.Sequential(
            nn.ReflectionPad2d(2),
